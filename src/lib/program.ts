...
export const DAY_A: DayTemplate = {
  ...
  exercises: [
    ...
    { name: 'Plank', sets: 3, repsMin: 20, repsMax: 30, unit: 'seconds', repsDisplay: '20–30s', rest: '45s', machine: 'Floor / mat', cues: 'Tight core, neutral spine, breathe. Dead bugs if plank too hard.', priority: 1 },
  ],
};
...
export const DAY_B: DayTemplate = {
  ...
  exercises: [
    { name: 'Romanian Deadlift', sets: 3, repsMin: 8, repsMax: 12, unit: 'reps', repsDisplay: '8–12', rest: '90s', machine: 'Smith Machine', cues: 'Soft knees, push hips back. Weight slides down thighs to mid-shin. Neutral spine — chest up. Squeeze glutes hard at top. Start light, learn the hinge.', priority: 1 },
