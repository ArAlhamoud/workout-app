...
export const DAY_A: DayTemplate = {
  ...
  exercises: [
    ...
    { name: 'Hip Adduction', sets: 2, repsMin: 12, repsMax: 15, unit: 'reps', repsDisplay: '12–15', rest: '60s', machine: 'Life Fitness (Hip Adduction — same machine, pads inside)', cues: 'Flip the pads to the INSIDE of the thighs and start with the legs open. Sit tall, back on the pad, hands light on the handles. Squeeze the knees TOGETHER by driving through the inner thighs — feel it along the inside of the leg, not the knee joint. In 2s, hold 1s with the pads touching, open 3s under control and stop just before the stack touches down. Usually a pin or two heavier than abduction. MISTAKE TO AVOID: setting the start position too wide — if the inner thigh pulls sharply at the start, close the range one notch.', youtubeUrl: 'https://www.youtube.com/watch?v=CjAVezAggkI', priority: 2 },
